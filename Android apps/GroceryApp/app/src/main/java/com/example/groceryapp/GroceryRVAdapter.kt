...
import com.example.groceryapp.GroceryRVAdapter.*
...
class GroceryRVAdapter (
    ...
    override fun onBindViewHolder(holder: GroceryViewHolder, position: Int) {
        ...
        holder.rateTV.text= "KN."+list.get(position).itemPrice.toString()
        val itemTotal : Int=list.get(position).itemPrice * list.get(position).itemQuantity
        holder.amountTV.text= "KN"+list.get(position).itemName
